    ...
    ((ScrollTrigger.prototype.init = function init(E, k) {
      if (((this.progress = this.start = 0), this.vars && this.kill(1), Ge)) {
        var m,
          ...
          ie,
          oe,
          ae = (E = xa(V(E) || X(E) || E.nodeType ? { trigger: E } : E, ht))
            .onUpdate,
          se = E.toggleClass,
          o = E.id,
          le = E.onToggle,
        ...
        if (
          ...
          vt.push(Me),
          me &&
            ((Y(me) && !me.push) || (me = { snapTo: me }),
            "scrollBehavior" in Fe.style &&
              Le.set(Ee ? [Fe, Ie] : Oe, { scrollBehavior: "auto" }),
            (f = W(me.snapTo)
              ? me.snapTo
              : "labels" === me.snapTo
          ...
          (pe = !0 === pe ? fe : Be(pe)[0]),
          V(se) && (se = { targets: fe, className: se }),
          pe &&
            (!1 === de ||
              de === lt ||
              (de = !(!de && "flex" === va(pe.parentNode).display) && st),
            (Me.pin = pe),
            !1 !== E.force3D && Le.set(pe, { force3D: !0 }),
